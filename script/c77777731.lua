...
function c77777731.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(c77777731.filter,tp,LOCATION_MZONE,0,1,nil,e,tp) end
...
function c77777731.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.SendtoDeck(tc,nil,2,REASON_EFFECT)and ft>0 and g:GetClassCount(Card.GetCode)>1 and tc:IsRelateToEffect(e) and tc:IsFaceup() then
    Duel.BreakEffect()
