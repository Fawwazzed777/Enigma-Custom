...
function c77777716.initial_effect(c)
	--xyz summon
	Xyz.AddProcedure(c,aux.FilterBoolFunctionEx(Card.IsRace,RACE_SPELLCASTER),4,2,nil,nil,5)
	c:EnableReviveLimit()
	--pendulum summon
...
--	e3:SetTarget(c77777716.sctg)
	...
	e5:SetCountLimit(1,77777716+EFFECT_COUNT_CODE_OATH)
...
function c77777716.rmtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(c77777716.rmfilter,tp,0,LOCATION_MZONE,1,nil) and Duel.IsExistingMatchingCard(c77777716.filter,tp,LOCATION_DECK,0,1,nil) end
