...
function c77777819.destg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return  Duel.IsExistingMatchingCard(c77777819.cfilter,tp,LOCATION_ONFIELD,LOCATION_ONFIELD,1,nil) and Duel.IsExistingMatchingCard(c77777819.filter2,tp,LOCATION_DECK,0,1,nil)end
	local g=Duel.GetMatchingGroup(c77777819.cfilter,tp,LOCATION_ONFIELD,LOCATION_ONFIELD,nil)
...
function c77777819.desop(e,tp,eg,ep,ev,re,r,rp)
  ...
  if Duel.Destroy(ct,REASON_EFFECT)~=0 then
  ct=ct:GetCount()
