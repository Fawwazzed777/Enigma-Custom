...
function c77777713.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=Duel.GetFieldCard(tp,LOCATION_PZONE,0)
	local pc=Duel.GetFieldCard(tp,LOCATION_PZONE,1)
	if chk==0 then return c:IsDestructable() and pc:IsDestructable() and Duel.IsExistingMatchingCard(c77777713.filter,tp,LOCATION_DECK,0,1,nil) end
