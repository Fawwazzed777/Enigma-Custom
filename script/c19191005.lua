...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		...
		and Duel.IsExistingTarget(aux.FaceupFilter(Card.IsSetCard,0xabc9),tp,LOCATION_MZONE,0,1,nil,c) end
	Duel.SelectTarget(tp,aux.FaceupFilter(Card.IsSetCard,0xabc9),tp,LOCATION_MZONE,0,1,1,nil,c)
