...
function s.tt(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.IsExistingMatchingCard(s.spfilter,tp,LOCATION_DECK,0,1,c:GetHandler():GetCode(),e,tp) end
...
function s.ot(e,tp,eg,ep,ev,re,r,rp)
	...
	local tc1=Duel.SelectMatchingCard(tp,s.spfilter,tp,LOCATION_DECK,0,1,1,c:GetHandler():GetCode(),e,tp)
	if tc and tc1 then
