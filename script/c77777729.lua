...
function c77777729.destg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chk==0 then return Duel.IsExistingTarget(c77777729.desfilter,tp,LOCATION_PZONE,0,1,nil) and Duel.IsExistingMatchingCard(c77777729.thfilter,tp,LOCATION_DECK,0,1,nil)end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_DESTROY)
	local g=Duel.SelectTarget(tp,c77777729.desfilter,tp,LOCATION_PZONE,0,1,1,nil)
