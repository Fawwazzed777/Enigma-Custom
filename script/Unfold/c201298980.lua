...
function s.ssfilter(c,e,tp)
	return c:IsSetCard(0x303) and c:IsType(TYPE_MONSTER) and c:IsLevelAbove(4) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP)
end
