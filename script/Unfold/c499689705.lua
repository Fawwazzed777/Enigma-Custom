--Aerolizer Blessing Wing
local s,id=GetID()
function s.initial_effect(c)
	--synchro summon
	Synchro.AddProcedure(c,nil,1,1,Synchro.NonTuner(Card.IsAttribute,ATTRIBUTE_WIND),1,1)
	c:EnableReviveLimit()
	--SpSummon
	...
	c:RegisterEffect(e1)
	--A WIND synchro monster effects using this card cannot be negated
