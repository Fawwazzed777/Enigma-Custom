...
function c66666690.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return  Duel.IsExistingTarget(c66666690.filter1,tp,0,LOCATION_SZONE,1,nil) and Duel.GetLocationCount(tp,LOCATION_SZONE)>0 end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_CONTROL)
	local g=Duel.SelectTarget(tp,c66666690.filter1,tp,0,LOCATION_SZONE,1,1,nil)
