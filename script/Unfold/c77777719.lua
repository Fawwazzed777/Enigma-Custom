...
--	e3:SetTarget(c77777719.sctg)
	...
	e5:SetCountLimit(1,77777819+EFFECT_COUNT_CODE_OATH)
	...
	e6:SetCountLimit(1,77777719+EFFECT_COUNT_CODE_OATH)
...
function c77777719.sptg2(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c77777719.spfilter,tp,LOCATION_GRAVE,0,1,nil,e,tp) end
...
function c77777719.spop2(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
	local g=Duel.SelectMatchingCard(tp,c77777719.spfilter,tp,LOCATION_GRAVE,0,1,1,nil,e,tp)
...
function c77777719.rmtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chk==0 then return Duel.IsExistingMatchingCard(c77777719.rmfilter,0,LOCATION_MZONE,0,1,nil) end
	Duel.SetOperationInfo(0,CATEGORY_REMOVE,nil,1,0,LOCATION_ONFIELD)
end
function c77777719.rmop(e,tp,eg,ep,ev,re,r,rp)
	local tc=Duel.SelectMatchingCard(tp,c77777719.rmfilter,tp,0,LOCATION_MZONE,1,1,nil)
