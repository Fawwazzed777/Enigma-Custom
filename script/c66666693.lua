...
function c66666693.initial_effect(c)
	...
	e2:SetCountLimit(1,66666693+EFFECT_COUNT_CODE_OATH)
...
function c66666693.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c66666693.cstfilter,tp,LOCATION_ONFIELD,0,1,nil)
...
function c66666693.spop(e,tp,eg,ep,ev,re,r,rp)
  ...
  Duel.BreakEffect()
	...
	local g2=Duel.SelectMatchingCard(tp,c66666693.filter,tp,LOCATION_DECK,0,1,1,nil,e,tp)
  ...
  local e4=Effect.CreateEffect(e:GetHandler())
	...
	e4:SetTarget(c66666693.splimit)
	e4:SetReset(RESET_PHASE+PHASE_END)
	Duel.RegisterEffect(e4,tp)
end
function c66666693.splimit(e,c,tp,sumtp,sumpos)
