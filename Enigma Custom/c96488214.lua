...
function s.mfilter(c,e,tp,mc)
	...
	return c:IsSetCard(0x344) and c:IsCanBeSpecialSummoned(e,0,tp,false,false) and not c:IsType(TYPE_TUNER)
...
function s.spfilter(c)
	return c:IsSetCard(0x344) and c:IsDiscardable()
end
