...
function c66666691.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c66666691.spfilter,tp,LOCATION_HAND,0,1,1,nil,e,tp)
  local tc=g:GetFirst()
...
function c66666691.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return  Duel.IsExistingTarget(c66666691.filter2,tp,0,LOCATION_SZONE,1,c) and Duel.GetLocationCount(tp,LOCATION_SZONE)>0 end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_CONTROL)
	local g=Duel.SelectTarget(tp,c66666691.filter2,tp,0,LOCATION_SZONE,1,1,nil)
