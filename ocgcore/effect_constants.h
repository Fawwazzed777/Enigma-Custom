...
//========== ATTRIBUTE ==========
#define ATTRIBUTE_RADIANT= 0x100
#define ATTRIBUTE_ALL    = ATTRIBUTE_EARTH|ATTRIBUTE_WATER|ATTRIBUTE_FIRE|ATTRIBUTE_WIND|ATTRIBUTE_LIGHT|ATTRIBUTE_DARK|ATTRIBUTE_DIVINE|ATTRIBUTE_RADIANT
//========== RACE ==========
#define RACE_VIRTUOUS    = 0x4000000
